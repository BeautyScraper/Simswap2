...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--Arc_path", type=str, default=r"C:\app\simswap\arcface_model\arcface_checkpoint.tar", help="run ONNX model via TRT")
        ...
        self.parser.add_argument("--temp_path", type=str, default=r'C:\dumpinggrounds', help="path to save temporarily images")
        self.parser.add_argument("--output_path", type=str, default='./output/', help="results path")
        self.parser.add_argument('--id_thres', type=float, default=0.09, help='how many test images to run')
        ...
        self.parser.add_argument('--indir', type=str, default=r'D:\paradise\stuff\simswappg\srcs', help='input dir')
        self.parser.add_argument('--target_dir', type=str, default= r'D:\paradise\stuff\new\PVD', help='target dir')
        self.parser.add_argument('--output_dir', type=str, default=r'D:\paradise\stuff\new\FS', help='output dir')
