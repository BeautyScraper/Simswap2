...
class Predictor(cog.Predictor):
    ...
    def predict(self, source, target, mode='all'):
        ...
        app = Face_detect_crop_multi(name='antelope', root=r'C:\app\simswap\insightface_func\models')

        if mode == 'single':
            app = Face_detect_crop_single(name='antelope', root=r'C:\app\simswap\insightface_func\models')
