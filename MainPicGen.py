...
if __name__ == '__main__':
    targetDir_parent = r'C:\Heaven\Haven\brothel'
    in_dir_parent = r'D:\paradise\stuff\simswappg\srcs\gudSrcs'
    all_src_dir = [str(x) for x in Path(in_dir_parent).glob('*') if x.is_dir()]
    ...
    for targetDir_global in targetDir_p_global:
        indir_global = choice(all_src_dir)
